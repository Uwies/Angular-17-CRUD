...
export class TutorialDetailsComponent implements OnInit {
  ...
  constructor(
    private tutorialService: TutorialService, private route: ActivatedRoute, private router: Router
  ) { }
  ...
  updatePublished(status: boolean): void {
    ...
    this.tutorialService.update(this.currentTutorial.id, data).subscribe({
      next: (res) => {
        ...
        this.message = res.message ? res.message : "The status was update successfully";
      }
    })
  }
